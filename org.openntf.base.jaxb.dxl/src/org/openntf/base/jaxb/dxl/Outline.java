 ...
 *         &lt;element name="outlineentry" type="{http://www.lotus.com/dxl}outlineentry" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "outline", namespace = "http://www.lotus.com/dxl", propOrder = {
    "noteinfo",
    "updatedby",
    "revisions",
    "wassignedby",
...
public class Outline {
    ...
    protected List<Outlineentry> outlineentry;
     ...
     * 
     */
    public List<Outlineentry> getOutlineentry() {
        if (outlineentry == null) {
            outlineentry = new ArrayList<Outlineentry>();
        }
        return this.outlineentry;
    }
